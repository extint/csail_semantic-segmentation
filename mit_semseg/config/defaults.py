...
_C.MODEL.weights_encoder = "./pth_files/encoder_epoch_20.pth"
# weights to finetune net_decoder
_C.MODEL.weights_decoder = "./pth_files/decoder_epoch_20.pth"
...
# epochs to train for
_C.TRAIN.num_epoch = 5
# epoch to start training. useful if continue from a checkpoint
_C.TRAIN.start_epoch = 20
